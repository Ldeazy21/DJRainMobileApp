    ...
    <SafeAreaView>
      <View>
        <View style={styles.container}>
          ...
          >
            <Text style={styles.timings}>12:43</Text>
            <Text style={styles.timings}>44:43</Text>
          </View>
